...
{
    public abstract class HospitalSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HospitalSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HospitalSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HospitalSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HospitalSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HospitalSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HospitalSystemDbContext, Task<T>> func)
        {
            T result;
